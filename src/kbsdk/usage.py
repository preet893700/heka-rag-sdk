...
from kbsdk.config import BudgetConfig, ModelPrice
from kbsdk.errors import BudgetExceededError
...
_current: ContextVar[UsageMeter | None] = ContextVar("kbsdk_usage_meter", default=None)
