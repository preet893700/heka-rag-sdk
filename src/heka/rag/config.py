...
from heka.rag.types import Filter
...
class EvalConfig(_Model):
    ...
    # Writes synthetic test questions (`heka-rag eval gen`). Prefer a model other than the one being
...
def available_presets() -> list[str]:
    root = resources.files("heka.rag.presets")
    return sorted(
