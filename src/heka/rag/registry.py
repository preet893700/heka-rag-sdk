...
* by third-party packages through the `heka.rag.plugins` entry-point group.
...
from heka.rag.errors import MissingExtraError, UnknownProviderError
...
ENTRY_POINT_GROUP = "heka.rag.plugins"
...
class Registry:
    ...
    def load_plugins(self) -> None:
        """Import every `heka.rag.plugins` entry point once; importing registers the adapters."""
